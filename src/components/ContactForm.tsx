        ...
        <div className="grid lg:grid-cols-2 gap-20 items-start">
          ...
          <FadeIn direction="right" className="space-y-12">
            ...
            <div className="grid sm:grid-cols-2 gap-8">
              ...
              <div className="flex gap-4">
                <a href="https://wa.me/994509627766" target="_blank" rel="noopener noreferrer" className="w-12 h-12 shrink-0 bg-gray-50 flex items-center justify-center rounded-xl hover:bg-gray-100 transition-colors">
                ...
                <div>
                  ...
                  <a href="https://wa.me/994509627766" target="_blank" rel="noopener noreferrer" className="text-lg font-bold text-black hover:text-black/70 transition-colors">
                    +994 50 962 77 66
                  </a>
                </div>
              </div>
