        ...
        <div className="grid lg:grid-cols-2 gap-20 items-start">
          ...
          <FadeIn direction="right" className="space-y-12">
            ...
            <div className="grid sm:grid-cols-2 gap-8">
              ...
              <div className="flex gap-4">
                <a href="https://wa.me/994501234567" target="_blank" rel="noopener noreferrer" className="w-12 h-12 shrink-0 bg-[#25D366]/10 flex items-center justify-center rounded-xl hover:bg-[#25D366]/20 transition-colors">
                ...
                <div>
                  <h4 className="text-[12px] font-black text-[#25D366] uppercase mb-1">WhatsApp</h4>
                  <a href="https://wa.me/994501234567" target="_blank" rel="noopener noreferrer" className="text-lg font-bold text-black hover:text-[#25D366] transition-colors">
                    +994 50 123 45 67
                  </a>
                </div>
              </div>
