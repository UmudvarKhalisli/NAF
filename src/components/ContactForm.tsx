        ...
        <div className="grid lg:grid-cols-2 gap-20 items-start">
          ...
          <FadeIn direction="right" className="space-y-12">
            ...
            <div className="grid sm:grid-cols-2 gap-8">
              <a href="tel:*7766" className="flex gap-4 group">
                <div className="w-12 h-12 shrink-0 bg-gray-50 flex items-center justify-center text-neutral-700 rounded-xl group-hover:bg-black group-hover:text-white transition-all">
                  <Phone size={24} />
                </div>
                <div>
              ...
              <a href="tel:*7766" className="flex gap-4 group">
                <div className="w-12 h-12 shrink-0 bg-gray-50 flex items-center justify-center rounded-xl group-hover:bg-[#25D366] group-hover:text-white transition-all">
                  <Phone size={24} className="text-[#333] group-hover:text-white" />
                </div>
                <div>
                  <h4 className="text-[12px] font-black text-black/40 uppercase mb-1">Mobil</h4>
                  <p className="text-lg font-bold text-black">+994 50 962 77 66</p>
                </div>
              </a>
