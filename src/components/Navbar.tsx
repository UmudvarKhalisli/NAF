        ...
        <div className="flex items-center justify-between gap-4">
          <a href="#hero" className="group flex items-center gap-3 flex-shrink-0">
            ...
            <div className="flex flex-col">
              <span className={`text-xl font-black tracking-tight transition-colors duration-500 ${scrolled || open ? "text-black" : "text-white"}`}>
                NAF
              </span>
              <span className={`text-[9px] font-bold tracking-[0.2em] transition-colors duration-500 ${scrolled || open ? "text-black/40" : "text-white/40"} uppercase`}>
                Texnika İcarəsi
              </span>
            </div>
          </a>
          ...
          <div className="flex items-center gap-4 lg:gap-8 flex-shrink-0">
            ...
            >
              <div className={`w-6 h-[2px] transition-all duration-300 ${open ? "rotate-45 translate-y-[8px]" : ""} ${scrolled || open ? "bg-black" : "bg-white"}`} />
              <div className={`w-6 h-[2px] transition-all duration-300 ${open ? "opacity-0" : ""} ${scrolled || open ? "bg-black" : "bg-white"}`} />
              <div className={`w-6 h-[2px] transition-all duration-300 ${open ? "-rotate-45 -translate-y-[8px]" : ""} ${scrolled || open ? "bg-black" : "bg-white"}`} />
            </button>
          </div>
        </div>
