        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-10">
          <div className="flex items-center justify-between gap-4">
            <a href="/#hero" className="group flex items-center gap-3 flex-shrink-0">
              <img src="/images/logo11.png" alt="NAF" className={`w-12 h-12 sm:w-16 sm:h-16 object-contain transition-all duration-500 ${forceSolid ? 'scale-90 mix-blend-multiply' : 'brightness-0 invert'}`} />
          ...
          >
            ...
            <div className="flex items-center justify-between py-5 mb-6">
              <a href="/#hero" onClick={() => setOpen(false)} className="flex items-center gap-2.5">
                <img src="/images/logo11.png" alt="NAF" className="w-12 h-12 object-contain mix-blend-multiply" />
            ...
            <div className="pt-6 pb-8 border-t border-black/5 space-y-5">
              ...
              <div className="flex gap-2">
                ...
                <a href="https://wa.me/994501234567" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-black/5 flex items-center justify-center text-black/40 hover:bg-black/10 transition-colors">       
