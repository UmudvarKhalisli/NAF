          ...
          >
            ...
            <div className="mt-auto py-12 border-t border-black/5 flex flex-col gap-8">
              ...
              <div className="flex gap-3">
                <a href="https://instagram.com/naf_construction" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-xl bg-gradient-to-br from-pink-500 to-purple-600 flex items-center justify-center text-white">       
                  <Instagram size={20} />
                </a>
                <a href="https://facebook.com/naf_construction" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-xl bg-[#1877F2] flex items-center justify-center text-white">       
                  <Facebook size={20} />
                </a>
                <a href="https://wa.me/994501234567" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-xl bg-[#25D366] flex items-center justify-center text-white">       
                ...
                <a href="https://tiktok.com/@naf_construction" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-xl bg-black flex items-center justify-center text-white">       
