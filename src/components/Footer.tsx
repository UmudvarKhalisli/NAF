...
const TikTokIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
    <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1v-3.5a6.37 6.37 0 00-.79-.05A6.34 6.34 0 003.15 15.2a6.34 6.34 0 0010.86 4.48V13a8.28 8.28 0 005.58 2.17V11.7a4.83 4.83 0 01-3.77-1.24V6.69h3.77z" fill="#ff0050"/>
    <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1v-3.5a6.37 6.37 0 00-.79-.05A6.34 6.34 0 003.15 15.2a6.34 6.34 0 0010.86 4.48V13a8.28 8.28 0 005.58 2.17V11.7a4.83 4.83 0 01-3.77-1.24V6.69h3.77z" fill="#00f2ea" opacity="0.7" transform="translate(-1, -1)"/>
  </svg>
);

export default function Footer() {
  const socialLinks = [
    { icon: <InstagramIcon />, href: "https://instagram.com/naf_construction", hoverBg: "hover:bg-pink-500/10" },
    { icon: <FacebookIcon />, href: "https://facebook.com/naf_construction", hoverBg: "hover:bg-blue-500/10" },
    { icon: <WhatsAppIcon />, href: "https://wa.me/994501234567", hoverBg: "hover:bg-green-500/10" },
    { icon: <TikTokIcon />, href: "https://tiktok.com/@naf_construction", hoverBg: "hover:bg-pink-500/10" },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div className="lg:col-span-1">
            <a href="#hero" className="flex items-center gap-3 mb-8 group">
              <img src="/logo.png" alt="NAF" className="w-10 h-10 object-contain invert" />
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((social, i) => (
                <a key={i} href={social.href} target="_blank" rel="noopener noreferrer" className={`w-10 h-10 rounded-full bg-white/5 flex items-center justify-center transition-all duration-300 ${social.hoverBg} hover:scale-110`}>
                  {social.icon}
                </a>
              ))}
            </div>
