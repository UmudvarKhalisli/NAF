...
export default function Footer() {
  const socialLinks = [
    ...
    { icon: "whatsapp", href: "https://wa.me/994501234567", hoverColor: "hover:text-[#25D366]" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div className="lg:col-span-1">
            <a href="#hero" className="flex items-center gap-3 mb-8 group">
              <img src="/images/logo11.png" alt="NAF" className="w-10 h-10 object-contain brightness-0 invert" />
